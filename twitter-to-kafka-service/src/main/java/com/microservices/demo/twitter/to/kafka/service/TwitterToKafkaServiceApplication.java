...
public class TwitterToKafkaServiceApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        LOGGER.info(Arrays.toString(this.twitterToKafkaServiceConfigData.getTwitterKeywords().toArray()));
        LOGGER.info(this.twitterToKafkaServiceConfigData.getWelcomeMessage());
        streamRunner.start();
    }
}
